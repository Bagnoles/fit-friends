        ...
        <div className="intro">
          ...
          <div className="intro__wrapper">
            ...
            <div className="intro__buttons">
              <button className="btn intro__button" type="button" onClick={() => navigate(AppRoutes.Register)}>Регистрация</button>
              <p className="intro__text">Есть аккаунт? <Link className="intro__link" to={AppRoutes.Login}>Вход</Link>
              </p>
            </div>
          </div>
        </div>
