      ...
      <div className="container"><span className="header__logo">
        ...
        <nav className="main-nav">
          <ul className="main-nav__list">
            <li className="main-nav__item"><Link className={activePage === 'main' ? 'main-nav__link is-active' : 'main-nav__link'} to={AppRoutes.Main} aria-label="На главную">
                <svg width="18" height="18" aria-hidden="true">
                  <use xlinkHref="#icon-home"></use>
                </svg></Link></li>
            <li className="main-nav__item"><Link className={activePage === 'profile' ? 'main-nav__link is-active' : 'main-nav__link'} to={AppRoutes.Profile} aria-label="Личный кабинет">
